          ...
          <div class="col-md-8 col-xl-8 middle-wrapper">
            <div class="card">
                <div class="card-body">
                    ...
                    <form id="myForm" action="{{ route('store.amenitie') }}" method="POST" class="forms-sample" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group mb-3">
                            <label for="amenitie_name" class="form-label">Amenitie</label>
                            <input type="text" class="form-control" name="amenitie_name">
                        </div>                        
                        <button type="submit" class="btn btn-inverse-primary me-2 px-4">Add Amenitie</button>
                    </form>
