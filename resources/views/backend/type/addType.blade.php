          ...
          <div class="col-md-8 col-xl-8 middle-wrapper">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('store.type') }}" method="POST" class="forms-sample" enctype="multipart/form-data">
                        @csrf
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('icon_type') is-invalid @enderror" name="icon_type">
                            @error('icon_type')
                                <span class="text-danger"> {{$message}} </span>
                            @enderror
                        </div>
