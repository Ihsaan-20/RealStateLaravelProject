...
<div class="page-content">
    ...
    <div class="mb-3">
        <a href="{{route('add.role')}}" class="btn btn-inverse-warning me-1">
            ...
            <div class="card-body">
                ...
                @foreach ($roles as $role )
                    <tr>
                        ...
                        <td>{{ $role->name}}</td>
                        <td>
                            <a href="{{route('edit.role',$role->id)}}" class="btn btn-inverse-warning">
                            ...
                            <a href="{{route('delete.role',$role->id)}}" class="btn btn-inverse-danger" id="delete">
                                Delete
