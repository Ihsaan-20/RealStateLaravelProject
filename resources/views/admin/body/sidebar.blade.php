<nav class="sidebar">
    ...
    <div class="sidebar-body">
      <ul class="nav">
        ...
        <li class="nav-item">
          <a class="nav-link" data-bs-toggle="collapse" href="#pro" role="button" aria-expanded="false" aria-controls="pro">
        ...
        <li class="nav-item">
          <a class="nav-link" data-bs-toggle="collapse" href="#amen" role="button" aria-expanded="false" aria-controls="amen">
            <i class="link-icon" data-feather="mail"></i>
            <span class="link-title">Amenitie</span>
            <i class="link-arrow" data-feather="chevron-down"></i>
          </a>
          <div class="collapse" id="amen">
            <ul class="nav sub-menu">
              <li class="nav-item">
        ...
        <li class="nav-item">
          <a class="nav-link" data-bs-toggle="collapse" href="#pern" role="button" aria-expanded="false" aria-controls="pern">
            <i class="link-icon" data-feather="mail"></i>
            <span class="link-title">Role & Permission</span>
            <i class="link-arrow" data-feather="chevron-down"></i>
          </a>
          <div class="collapse" id="pern">
            <ul class="nav sub-menu">
              <li class="nav-item">
